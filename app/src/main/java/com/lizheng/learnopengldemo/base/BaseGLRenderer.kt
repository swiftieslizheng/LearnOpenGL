package com.lizheng.learnopengldemo.base
...
abstract class BaseGLRenderer: GLSurfaceView.Renderer,IGLRenderer {
    ...
    abstract fun onViewChanged(width: Int, height: Int)
}